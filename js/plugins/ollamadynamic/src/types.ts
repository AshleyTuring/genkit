...
export type DynamicConfiguration = ( params: { modelName:string, requestId: string }, request: GenerateRequest ) => Promise<{ serverAddress: string; name: string; type?: ApiType; authToken:Record<string, string>}>
